        ...
        <div class="container">
            ...
            <div class="content-outer">
                ...
                <div class="post-buttons">
					<a href="${contextPath}/board/list"><button class="btn-list">목록</button></a>
                    <a href="${contextPath}/board/modify"><button class="btn-edit">수정</button></a>
                    <a href="${contesxPath}/board/delete/{postNo}"><button class="btn-delete">삭제</button></a>
                </div>
